...
namespace EnterWeights
{
    public partial class frmView : Form
    {
        ...
        //=======================================================================================================
        //This method is called when the dgv needs to be refreshed when the list PartWeights changes. It properly
        ...
        public void RefreshDGV()
        {
            ...
            dgvOutput.DataSource = Program.PartWeights;
            ...
            dgvOutput.Columns[2].HeaderText = "Operation";
            dgvOutput.Columns[3].HeaderText = "Part Number";
            dgvOutput.Columns[4].HeaderText = "Weight";
            dgvOutput.Columns[5].HeaderText = "Part Name";
            dgvOutput.Columns[6].HeaderText = "Standard Pack";
            dgvOutput.AutoResizeColumns();
            dgvOutput.Refresh();   
        }
           
        //=======================================================================================================
        //This method is called when the user clicks anywhere on the dgv, it assumes that the user is currently
        //  in the update entry mode, in case they are, it will then set the pnlUpdate.Visible to false so the
        //  text boxes will never be out-of-date, no matter what the user is trying to do.
        //=======================================================================================================
        private void dgvOutput_Click(object sender, EventArgs e)
        {
            pnlDefault.Visible = true;
            pnlUpdate.Visible = false;
            pnlArchiveView.Visible = false;
        ...
        public void GetSelectedRow()
        {
            ...
            if (Program.PartWeights.Count > 0)
            {
                ...
                txtPN.Text = Program.PartWeights[indexOn].PN;
                txtOp.Text = Program.PartWeights[indexOn].Operation.ToString();
                txtDepartUpdate.Text = Program.PartWeights[indexOn].Dept;
                txtWeight.Text = Program.PartWeights[indexOn].Weight.ToString();
                txtPartName.Text = Program.PartWeights[indexOn].PartName.ToString();
                txtStdPack.Text = Program.PartWeights[indexOn].StdPack.ToString();
                intTUID = Program.PartWeights[indexOn].TUID;
            }
        } 

        //=======================================================================================================
        //This method is called when the frmView is loaded, it sets the version label to the current running 
        //  version of EnterWeights to easily be able to identify which version the user is using
        //=======================================================================================================
