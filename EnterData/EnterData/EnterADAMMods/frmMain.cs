    ...
    public partial class frmMain : Form
    {
        ...
        private async void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (tempDept != "" && tempModName != "" && tempIPAddress != "")
            {
                ...
                _splash.Focus();
                await Task.Delay(200);
                DatabaseFunctions.InsertNew(tempDept, tempModName, tempIPAddress);
                txtModName.Text = "";
                txtIPAddress.Text = "";
                _splash.Close();
            }
        ...
        //  version of EnterADAMMods. Allows to easily see if the user needs to update their version since I
        ...
        //=======================================================================================================
        private void frmADAM_Closing(object sender, EventArgs e)
        {
