...
namespace EnterADAMMods
{
    public partial class frmView : Form
    {
        ...
        //=======================================================================================================
        //This method is called when the dgv needs to be refreshed when the list ADAMMods changes. It properly
        ...
        public void RefreshDGV()
        {
            ...
            dgvOutput.DataSource = Program.ADAMMods;
            ...
            dgvOutput.Columns[2].HeaderText = "Module Name";
            dgvOutput.Columns[3].HeaderText = "IP Address";
            dgvOutput.AutoResizeColumns();
            dgvOutput.Refresh();
        }
        ...
        //  version of EnterADAMMods to easily be able to identify which version the user is using
        //=======================================================================================================
        ...
        //  than 0 it refreshes the dgv to show the current modules entered in the specified department
        //=======================================================================================================
        ...
        public void GetSelectedRow()
        {
            ...
            if (Program.ADAMMods.Count > 0)
            {
                ...
                intTUID = Program.ADAMMods[indexOn].TUID;
                txtDepartUpdate.Text = Program.ADAMMods[indexOn].Dept;
                txtModName.Text = Program.ADAMMods[indexOn].ModName;
                txtIPAddress.Text = Program.ADAMMods[indexOn].IPAddress;
            }    
        }
        ...
        //  make sure the user wants to archive the module, if they click yes, it calls the "Archiving" method in
        ...
        //  It properly updates the dgv to show all entries in the modules table again
        //========================================================================================================
        ...
        //  0 entries currently in the module list, if there isnt any, it will tell the user there are no 
        ...
        //=======================================================================================================
        //This method is called when the frmView is closing, it shows frmMain again and disposes the current 
        //  instance of frmView
        //=======================================================================================================
