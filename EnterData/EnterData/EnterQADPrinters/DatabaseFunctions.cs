...
namespace EnterQADPrinters
{
    ...
    {
        public static string LDBDataDestination = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "EnterData", "QADPrinters.mdf");
        public static string LDBConn = "SERVER=" + Program.LServer + ";DATABASE=" + Program.QADLDBName + ";Integrated Security=SSPI;AttachDbFileName=" + LDBDataDestination;
        ...
        //=========================================================================================================
        //This method inserts a new record into the qad printer table. The parameters come from the text boxes that 
        ...
        //  I noticed it was easy for the user to enter the same printer more than once, which made me 
        //  create a constriant in the db to disallow the user to add the same printer more than once.
        //=========================================================================================================
        public static void InsertNew(string strDept, string strPrinterName)
        {
            try
            {
                SqlCommand _LDBComm = new SqlCommand();
                ...
                _LDBComm.Connection = _LDBConn;
                _LDBComm.CommandType = CommandType.StoredProcedure;
                _LDBComm.CommandText = "[dbo].[Insert_Into_QAD_Printer_SP]";
                _LDBComm.Parameters.AddWithValue("@strDept", strDept);
                _LDBComm.Parameters.AddWithValue("@strPrinterName", strPrinterName);
                _LDBComm.ExecuteNonQuery();
                _LDBConn.Close();
                DetachFile();   
            }
        ...
        public static void ViewCurrent()
        {
            ...
            try
            {
                ...
                _LDBComm.Connection = _LDBConn;
                _LDBComm.CommandType = CommandType.StoredProcedure;
                _LDBComm.CommandText = "[dbo].[Get_All_Printers_SP]";
                _Adap = new SqlDataAdapter(_LDBComm);
                _Adap.Fill(_DS);
                var allRows = _DS.Tables[0].Rows;
                _LDBConn.Close();
                LoadLists.LoadQADList(allRows);
            }
            catch (Exception ex)
            {
        ...
        //=======================================================================================================
        //This method called when the user wants to narrow the current printer list down to a specific department.
        //  Its parameter is what is currently entered into the text box on frmView. If the user does not 
        //  enter any kind of string in the text box it assumes the user wants to view all records in the printer
        ...
        public static void NarrowToDept(string strDept)
        {
            ...
            try
            {
                ...
                _LDBComm.Connection = _LDBConn;
                _LDBComm.CommandType = CommandType.StoredProcedure;
                _LDBComm.CommandText = "[dbo].[Get_All_Dept_QAD_Printers_SP]";
                _LDBComm.Parameters.AddWithValue("@strDept", strDept);
                _Adap = new SqlDataAdapter(_LDBComm);
                _Adap.Fill(_DS);
                var allRows = _DS.Tables[0].Rows;
        ...
        //  either a duplicated printer or the wrong data type is entered
        //=======================================================================================================
        public static void UpdatePrinter(string strDept, string strPrinterName, int intTUID)
        {
            try
            {
                SqlCommand _LDBComm = new SqlCommand();
                ...
                _LDBComm.Connection = _LDBConn;
                _LDBComm.CommandType = CommandType.StoredProcedure;
                _LDBComm.CommandText = "[dbo].[Update_QAD_Printer_SP]";
                _LDBComm.Parameters.AddWithValue("@strDept", strDept);
                _LDBComm.Parameters.AddWithValue("@strPrinterName", strPrinterName);
        ...
        public static void Archiving(bool Archive)
        {
            ...
            try
            {
                ...
                {
                    _LDBComm.CommandType = CommandType.StoredProcedure;
                    _LDBComm.CommandText = "[dbo].[Archive_Printer_Entry_SP]";
                }
                else
                {
                    _LDBComm.CommandType = CommandType.StoredProcedure;
                    _LDBComm.CommandText = "[dbo].[Unarchive_Printer_Entry_SP]";
                }
        ...
        //=======================================================================================================
        //This method is called when the user wants to view the currently archived list in the printer table. I
        ...
        public async static void ViewArchive()
        {
            ...
            try
            {
                ...
                _LDBComm.Connection = _LDBConn;
                _LDBComm.CommandType = CommandType.StoredProcedure;
                _LDBComm.CommandText = "[dbo].[Get_Archive_Printers_SP]";
                _Adap = new SqlDataAdapter(_LDBComm);
                _Adap.Fill(_DS);
                var allRows = _DS.Tables[0].Rows;
                LoadLists.LoadQADList(allRows);
        ...
        //=======================================================================================================
        //This method called when the user decides they want to delete an entry from the archived printers. It 
        ...
        public static void DeleteEntry(int intTUID)
        {
            ...
            try
            {
                ...
                _LDBConn.Open();
                _LDBComm.CommandType = CommandType.StoredProcedure;
                _LDBComm.CommandText = "[dbo].[Delete_Entry_Printers_SP]";
                _LDBComm.Parameters.AddWithValue("@intTUID", intTUID);
                _LDBComm.Connection = _LDBConn;
                _LDBComm.ExecuteNonQuery();
                _LDBConn.Close();
